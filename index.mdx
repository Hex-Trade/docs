...
<Steps>
  <Step title="Create your account">
    ...
    <video src="/videos/New-Project-3-Copy.webm" controls />
  </Step>
  <Step title="Log in to your account">
    [Log in at dash.hextrade.io/login](https://dash.hextrade.io/login)

    <video src="/videos/Create-Account.webm" controls />
  </Step>
  <Step title="Purchase premium (optional)">
    [Purchase at dash.hextrade.io/subscriptions](https://dash.hextrade.io/subscriptions)

    <video src="/videos/Premium-1.webm" controls />
  </Step>
  <Step title="Connect a broker account">
    Go to [Accounts](https://dash.hextrade.io/accounts) and add your first broker or prop firm account. See [Trading Accounts](/automated-trading/trading-accounts) for the full list of supported platforms.<br />

    <video src="/videos/Add-Account.webm" controls />
  </Step>
