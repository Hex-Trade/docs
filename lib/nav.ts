...
export const nav: NavGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: "Pine Script alerts", href: "/pine-script-alerts", slug: "pine-script-alerts", icon: Webhook },
      { title: "Webhook troubleshooting", href: "/webhook-troubleshooting", slug: "webhook-troubleshooting", icon: CircleHelp },
      { title: "Symbol mapping", href: "/symbol-mapping", slug: "symbol-mapping", icon: Scale },
      { title: "Tradovate webhook", href: "/tradovate-webhook", slug: "tradovate-webhook", icon: TrendingUp, image: "/images/platforms/tradovate.png" },
