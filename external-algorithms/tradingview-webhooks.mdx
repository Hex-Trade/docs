...
sidebarTitle: TradingView Webhooks
description: Connect your TradingView Pine Script strategy to Hextrade via webhook. Automate order execution on ProjectX, Tradovate, Rithmic, TradeLocker, and more.
---
...
<video autoPlay loop muted playsInline controls style={{ width: "100%", borderRadius: "0.5rem" }}>
  <source src="/videos/tradingview-webhooks.mp4" type="video/mp4" />
</video>
...
Set `platformType` to the lowercase value shown below.

<Columns cols={3}>
<Card title="ProjectX">
<img src="/images/platforms/projectx.png" alt="ProjectX" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`projectx` — futures
</Card>
<Card title="Tradovate">
<img src="/images/platforms/tradovate.png" alt="Tradovate" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`tradovate` — futures
</Card>
<Card title="NinjaTrader">
<img src="/images/platforms/ninjatrader.png" alt="NinjaTrader" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`ninjatrader` — futures
</Card>
<Card title="Rithmic">
<img src="/images/platforms/rithmic.png" alt="Rithmic" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`rithmic` — futures
</Card>
<Card title="TradeLocker">
<img src="/images/platforms/tradelocker.png" alt="TradeLocker" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`tradelocker` — multi-asset / prop
</Card>
<Card title="MatchTrader">
<img src="/images/platforms/matchtrader.png" alt="MatchTrader" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`matchtrader` — forex / CFDs
</Card>
<Card title="Volumetrica">
<img src="/images/platforms/volumetrica.png" alt="Volumetrica" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`volumetrica` — futures
</Card>
<Card title="MetaTrader 5">
<img src="/images/platforms/metatrader5.png" alt="MetaTrader 5" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`mt5` — multi-asset
</Card>
<Card title="Oanda">
<img src="/images/platforms/oanda.png" alt="Oanda" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`oanda` — forex / CFDs
</Card>
<Card title="Hyperliquid">
<img src="/images/platforms/hyperliquid.png" alt="Hyperliquid" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />

`hyperliquid` — crypto perps
</Card>
<Card title="Plus500">
<img src="/images/platforms/plus500.png" alt="Plus500" width="28" height="28" style={{ borderRadius: "6px", marginBottom: "8px" }} />
...
| Field | Description |
|-------|-------------|
| `platformType` | The broker — `projectx`, `tradovate`, `ninjatrader`, `rithmic`, `tradelocker`, `mt5`, etc. |
...
- `"platformType"` — Set to your broker (e.g. `"projectx"`, `"tradovate"`, `"rithmic"`).
...
| `platformType` error | Use lowercase: `projectx`, `tradovate`, `ninjatrader`, `rithmic`, `tradelocker`, `mt5`. |
