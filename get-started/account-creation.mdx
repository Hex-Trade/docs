...
<video src="/videos/Create-Account-1.mp4" controls />
...
<Warning>
  Never share your password. Hextrade staff will never ask for your password. Enable two-factor authentication from [Settings](/settings) once logged in.
</Warning>
