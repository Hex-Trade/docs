...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/webhooks/pine-script", destination: "/pine-script-alerts", permanent: true },
      { source: "/webhooks/troubleshooting", destination: "/webhook-troubleshooting", permanent: true },
      { source: "/webhooks/tradovate", destination: "/tradovate-webhook", permanent: true },
