...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/brokers-futures", destination: "/tradovate", permanent: true },
      { source: "/brokers-cfds", destination: "/tradelocker", permanent: true },
      { source: "/brokers-crypto", destination: "/hyperliquid", permanent: true },
      { source: "/faq-sizing", destination: "/position-sizing", permanent: true },
