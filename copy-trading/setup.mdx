...
<video autoPlay loop muted playsInline controls style={{ width: "100%", borderRadius: "0.5rem" }}>
  <source src="/videos/copy-trading.mp4" type="video/mp4" />
</video>
...
Select one or more **follower accounts**. Copy trading currently supports **ProjectX**, **Tradovate**, **NinjaTrader**, **Rithmic**, and **Volumetrica**. All accounts must already be connected — see [Trading Accounts](/automated-trading/trading-accounts).
</Step>
...
<Note>
Copy trading is limited to **ProjectX**, **Tradovate**, **NinjaTrader**, **Rithmic**, and **Volumetrica**. Cross-platform groups among those five are supported. Other connected brokers can run algorithms and webhooks but cannot be used as copy-trade master or follower.
</Note>
